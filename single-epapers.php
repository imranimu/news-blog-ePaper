<?php
/**
 * The template for displaying building single pages.
 *
                                            ...
                                            if ($_GET['page'] == 'page2') { 
                                                ...
                                                if ($page_two) {
                                                    ...
                                                    <div class="slider_pagination">
                                                        <a href="<?php echo $get_link;?>/?page=page1" class="pre"></a>
                                                        <a href="<?php echo $get_link;?>/?page=page3" class="next"></a> 
                                                    </div>
                                                ...
                                                if ($page_three) {
                                                    ...
                                                    <div class="slider_pagination">
                                                        <a href="<?php echo $get_link;?>/?page=page2" class="pre"></a>
                                                        <a href="<?php echo $get_link;?>/?page=page4" class="next"></a> 
                                                    </div>
                                                    <?php
                                                }
                                                ...
                                                if ($page_one) {
                                                    ...
                                                    <div class="slider_pagination">                                                     
                                                        <a href="<?php echo $get_link;?>?page=page2" class="next"></a> 
                                                    </div>
                                                    <?php
                                                }
                                            }
