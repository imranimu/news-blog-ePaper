					...
					<div class="ePaper_wrap">						
						<div class="row ">							
							<div class="paper_pagination">
								<h2>
									<img src="<?php echo get_template_directory_uri();?>/img/today.png" alt="Today's News">
								</h2>
							</div>								
					                    	...
					                    	if ($_GET['page'] == 'page2') {	
												...
												if ($page_two) {
													...
													<div class="slider_pagination">
														<a href="<?php echo home_url();?>/?page=page1" class="pre"></a>
														<a href="<?php echo home_url();?>/?page=page3" class="next"></a> 
													</div>
												...
												if ($page_three) {
													...
													<div class="slider_pagination">
														<a href="<?php echo home_url();?>/?page=page2" class="pre"></a>
														<a href="<?php echo home_url();?>/?page=page4" class="next"></a> 
													</div>
						                    		<?php
						                    	}
                                                ...
                                                if ($page_four) {
                                                    ...
                                                    <div class="slider_pagination">
                                                        <a href="<?php echo $get_link;?>/?page=page3" class="pre"></a>
                                                        <?php 
                                                            if ($page_five) {
                                                                ?>
                                                                <a href="<?php echo $get_link;?>/?page=page5" class="next"></a> 
                                                                <?php        
                                                            }else{
                                                                ?>
                                                                <a href="<?php echo $get_link;?>/?page=page1" class="next"></a> 
                                                                <?php        
                                                            }
                                                        ?>                                                        
                                                    </div>
                                                ...
                                                if ($page_five) {
                                                    ...
                                                    <div class="slider_pagination">                                                        
                                                        <a href="<?php echo $get_link;?>/?page=page4" class="pre"></a>
                                                        <a href="<?php echo $get_link;?>/?page=page6" class="next"></a>
                                                    </div>
                                                    <?php                                            
                                                }
                                                ...
                                                if ($page_six) {
                                                    ...
                                                    <div class="slider_pagination">
                                                        <a href="<?php echo $get_link;?>/?page=page5" class="pre"></a>
                                                        <a href="<?php echo $get_link;?>/?page=page7" class="next"></a>
                                                    </div>
                                                    <?php                                            
                                                }
                                                ...
                                                if ($page_seven) {
                                                    ...
                                                    <div class="slider_pagination">
                                                        <a href="<?php echo $get_link;?>/?page=page6" class="pre"></a>
                                                        <a href="<?php echo $get_link;?>/?page=page8" class="next"></a>
                                                    </div>
                                                    <?php                                            
                                                }
                                                ...
                                                if ($page_eight) {
                                                    ...
                                                    <div class="slider_pagination">
                                                        <a href="<?php echo $get_link;?>/?page=page7" class="pre"></a>
                                                        <a href="<?php echo $get_link;?>/?page=page1" class="next"></a>
                                                    </div>
                                                    <?php                                            
                                                }
												...
												if ($page_one) {
													...
													<div class="slider_pagination">														
														<a href="<?php echo home_url();?>/?page=page2" class="next"></a> 
													</div>
						                    		<?php
						                    	}
											}
				...
				<div class="col-md-4">
					...
					<div class="sidebars-area">		 
						<div class="single-sidebar-widget editors-pick-widget">
							...
							<div class="allnews single-sidebar-widget">
								...
								<div class="allnews_image">
                                    <?php if ($page_one): ?>
                                        <div class="image_wrap <?php if ($_GET['page'] == 'page1' || !isset($_GET['page']) ) { echo 'active'; }?>">
                                            <a href="<?php echo $get_link;?>/?page=page1" title="Page 1">
                                    ...
                                    <?php if ($page_two): ?>
                                        <div class="image_wrap <?php if ($_GET['page'] == 'page2') {echo 'active'; }?>">
                                            <a href="<?php echo $get_link;?>/?page=page2" title="Page 2">
                                    ...
                                    <?php if ($page_three): ?>
                                        <div class="image_wrap <?php if ($_GET['page'] == 'page3') {echo 'active'; }?>">
                                            <a href="<?php echo $get_link;?>/?page=page3" title="Page 3">
                                    ...
                                    <?php if ($page_four): ?>
                                        <div class="image_wrap <?php if ($_GET['page'] == 'page4') {echo 'active'; }?>">
                                            <a href="<?php echo $get_link;?>/?page=page4" title="Page 4">
                                    ...
                                    <?php if ($page_five): ?>
                                        <div class="image_wrap <?php if ($_GET['page'] == 'page5') {echo 'active'; }?>">
                                            <a href="<?php echo $get_link;?>/?page=page5" title="Page 5">
                                    ...
                                    <?php if ($page_six): ?>
                                        <div class="image_wrap <?php if ($_GET['page'] == 'page6') {echo 'active'; }?>">
                                            <a href="<?php echo $get_link;?>/?page=page6" title="Page 6">
                                    ...
                                    <?php if ($page_seven): ?>
                                        <div class="image_wrap <?php if ($_GET['page'] == 'page7') {echo 'active'; }?>">
                                            <a href="<?php echo $get_link;?>/?page=page7" title="Page 7">
                                    ...
                                    <?php if ($page_eight): ?>
                                        <div class="image_wrap <?php if ($_GET['page'] == 'page8') {echo 'active'; }?>">
                                            <a href="<?php echo $get_link;?>/?page=page8" title="Page 8">
							...
							<div class="news_archives single-sidebar-widget">				
								...
								<div class="textwidget">
									<p>
										<a href="https://dainikjanmobhumi.com">
											<img class="alignnone size-medium wp-image-38" src="https://dainikjanmobhumi.com/wp-content/uploads/2019/01/onlinepaper-logo.png" alt="" width="300" height="108">
										</a>
									</p>
								</div>
							</section>
