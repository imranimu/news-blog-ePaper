...
function pro_news_scripts() {
	...
	wp_enqueue_script( 'googleapis', get_template_directory_uri() . 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA', array(), '20151215', true );
